...
public class LibraryEventControllerUnitTest {
    ...
    public void postLibraryEvent() throws Exception {
        ...
        when(libraryEventProducer.sendLibraryEventAsProducerRecord(isA(LibraryEvent.class))).thenReturn(null);
    ...
    public void postLibraryEvent_4xx() throws Exception {
        ...
        // doNothing().when(libraryEventProducer).sendLibraryEventAsProducerRecord(isA(LibraryEvent.class));
        when(libraryEventProducer.sendLibraryEventAsProducerRecord(isA(LibraryEvent.class))).thenReturn(null);
